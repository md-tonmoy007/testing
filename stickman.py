...
g = Game()
platform1 = PlatformSprite(g, PhotoImage(file="bg.png"), 0, 480, 100, 10)
platform2 = PlatformSprite(g, PhotoImage(file="bg.png"), 150, 440, 100, 10)
platform3 = PlatformSprite(g, PhotoImage(file="bg.png"), 300, 400, 100, 10)
platform4 = PlatformSprite(g, PhotoImage(file="bg.png"), 300, 160, 100, 10)
